...
findweil(f,p,initial) =
{
	...
	while(n>=initial,
		...
		if(success,if(check_symmetry(g,p,w),return(g)))
	);
...
do_it(A)=
{
	...
	print("The characteristic polynomial is: ",g);
	print("Its Newton polygon is: ",newtonpoly(g,2));
	print("Its factorization is: ",factor(g));
